...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Youbercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"youbercointools.com", "5.225.112.18"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"youbercointools.com", "testnet-seed.youbercointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Youbercoin is probably already running."), addrBind.ToString().c_str());
        else
